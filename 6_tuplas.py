...
dias_semana=("LUNES","MARTES","MIERCOLES","JUEVES","VIERNES","SABADO","DOMINGO","SABADO")
...
indice = dias_semana.index("SABADO")
print(f"El índice de la primera aparición del valor SABADO es: {indice}")

# Usando el método count para contar cuántas veces aparece el valor 3 en la tupla
conteo = dias_semana.count("SABADO")
print(f"El valor SABADO aparece {conteo} veces en la tupla")
...
subtupla = dias_semana[3:5]  # Obteniendo una subtupla desde el elemento 3 hasta el segundo elemento 5
